$(document).ready(function() {
    ...
    let url = `http://10.10.10.38/decisions/Primary/?ReportId=a2fb5afb-11c1-11e8-97ae-9cb6d0d26d62&Action=api&userid=admin%40decisions.com&password=admin&outputtype=JSON`;
    ...
    $('#add-player-button').click(function(e) { 
      ...
      if (playerName === "") {
        ...
        var url = "http://10.10.10.38/decisions/Primary/?FlowId=0ded4b0f-1102-11e8-97ae-9cb6d0d26d62&Action=api";
    ...
    $('#add-record-button').click(function(e) { 
      ...
      if (gameName === "") {
        ...
        var url = "http://10.10.10.38/decisions/Primary/?FlowId=d1e959ff-1334-11e8-97af-9cb6d0d26d62&Action=api";
        let parameters = JSON.stringify({
          "userid": "admin@decisions.com",
          "password": "admin",
          "outputtype": "Json",
      ...
      console.log(gameName); //use the console for debugging, F12 in Chrome, not alerts
    });
    //END ADD RECORD
